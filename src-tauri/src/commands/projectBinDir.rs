...
pub fn add_folder<R: Runtime>(app_handle: AppHandle<R>, selected_dir_id: String) -> Result<Directory, String>{
...
fn get_safe_parent_dir_id<R: Runtime>(desired_id: &String, cur_dir_state: &State<Directory>) -> String {
